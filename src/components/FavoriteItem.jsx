...
import { deleteFavorite, changeIcon } from '../store/airPollution'

const FavoriteItem = ({ item }) => {
  const dispatch = useDispatch()

  const deleteFavoriteHandler = item => {
    dispatch(deleteFavorite(item))
    dispatch(changeIcon(item))
  }

  return (
    <StyledFavoriteItem item={item}>
...
const StyledFavoriteItem = styled.div`
  margin: auto;
  width: 80%;
  height: 150px;
